<?php
	...
	$firstname=$_POST['textfield10'];
	$lastname=$_POST['textfield20'];
	$phone=$_POST['textfield30'];
	$email=$_POST['textfield40'];
...
<p class="BodyTextSmall">Mott Street Optical, Inc <br>
  ...
  <td valign="top"><table width="100%" border="1" style="BORDER-COLLAPSE: collapse" bordercolor="#111111">
    ...
    <tr>
      <td valign="top"><span class="BodyTextWhite">Last Name :</span></td>
      <td valign="top"><font color="#3300CC">'.$lastname.'</font></td>
    </tr>
    <tr>
      <td valign="top"><span class="BodyTextWhite">Phone Number :</span></td>
      <td valign="top"><font color="#3300CC">'.$phone.'</font></td>
    </tr>
    <tr>
	...
	$mimemessage->send('Mottoptical', 'lws1314@yahoo.com', $subject);
